...
If your provider doesn't accept at-parameters you can modify `InterpolatedStatementParser.AutoGeneratedParameterPrefix` and `InterpolatedStatementParser.AutoGeneratedParameterObjectPrefix`:
...
```cs
InterpolatedStatementParser.AutoGeneratedParameterPrefix = "@PARAM_";
InterpolatedStatementParser.AutoGeneratedParameterObjectPrefix = "PARAM_";
