...
namespace DapperQueryBuilder
{
    ...
    public static class ICompleteCommandExtensions
    {
        ...
        {
            return command.Connection.Execute(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.ExecuteAsync(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.ExecuteScalar(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.ExecuteScalarAsync<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.ExecuteScalarAsync(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.Query<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, buffered: buffered, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirst<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirstOrDefault<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QuerySingle<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QuerySingleOrDefault<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        #endregion
        ...
        {
            return command.Connection.Query(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, buffered: buffered, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirst(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirstOrDefault(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QuerySingle(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QuerySingleOrDefault(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        #endregion
        ...
        {
            return command.Connection.Query(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, buffered: buffered, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirst(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirstOrDefault(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QuerySingle(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QuerySingleOrDefault(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        #endregion
        ...
        {
            return command.Connection.QueryAsync<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirstAsync<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        /// <summary>
        /// Executes the query (using Dapper), returning the data typed as T.
        /// </summary>
        ...
        {
            return command.Connection.QueryFirstOrDefaultAsync<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        /// <summary>
        /// Executes the query (using Dapper), returning the data typed as T.
        /// </summary>
        ...
        {
            return command.Connection.QuerySingleAsync<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        /// <summary>
        /// Executes the query (using Dapper), returning the data typed as T.
        /// </summary>
        ...
        {
            return command.Connection.QuerySingleOrDefaultAsync<T>(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        #endregion
        ...
        {
            return command.Connection.QueryAsync(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirstAsync(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirstOrDefaultAsync(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QuerySingleAsync(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QuerySingleOrDefaultAsync(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        #endregion
        ...
        {
            return command.Connection.QueryAsync(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.QueryFirstAsync(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        /// <summary>
        /// Executes the query (using Dapper), returning the data typed as type.
        /// </summary>
        ...
        {
            return command.Connection.QueryFirstOrDefaultAsync(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        /// <summary>
        /// Executes the query (using Dapper), returning the data typed as type.
        /// </summary>
        ...
        {
            return command.Connection.QuerySingleAsync(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        /// <summary>
        /// Executes the query (using Dapper), returning the data typed as type.
        /// </summary>
        ...
        {
            return command.Connection.QuerySingleOrDefaultAsync(type: type, sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        #endregion
        ...
        {
            return command.Connection.ExecuteReader(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        ...
        {
            return command.Connection.ExecuteReaderAsync(sql: command.Sql, param: command.Parameters.Values, transaction: transaction, commandTimeout: commandTimeout, commandType: commandType);
        }
        #endregion
