...
namespace DapperQueryBuilder
{
    ...
    public class ParameterInfos : Dictionary<string, ParameterInfo>, SqlMapper.IDynamicParameters, SqlMapper.IParameterCallbacks
    {
        ...
        public string Add(object value, DbType? dbType = null, ParameterDirection? direction = null)
        {
            ...
            string objectPrefix = DapperQueryBuilderOptions.AutoGeneratedParameterPrefix + (isEnumerable ? "array" : "");
            string paramPrefix = DapperQueryBuilderOptions.AutoGeneratedParameterChar +  DapperQueryBuilderOptions.AutoGeneratedParameterPrefix + (isEnumerable ? "array" : "");
            if (DapperQueryBuilderOptions.ReuseIdenticalParameters)
            {
                ...
                if (existingParam != null)
                    return paramPrefix + existingParam.Name.Substring(objectPrefix.Length);
            }

            var parmCount = Values.Count;
            var parmName = paramPrefix + parmCount.ToString();
            var parmObjectName = objectPrefix + parmCount.ToString();
        ...
        public string MergeParameter(ParameterInfo parameter)
        {
            ...
            string objectPrefix = DapperQueryBuilderOptions.AutoGeneratedParameterPrefix + (isEnumerable ? "array" : "");
            string paramPrefix = DapperQueryBuilderOptions.AutoGeneratedParameterPrefix + (isEnumerable ? "array" : "");

            string newParameterName = objectPrefix + ParameterNames.Count;
        ...
        public string MergeParameters(ParameterInfos parameters, string sql)
        {
            ...
            foreach (var parameter in parameters.Values)
            {
                ...
                if (newParameterName != null && parameter.Name != newParameterName)
                    renamedParameters.Add(DapperQueryBuilderOptions.AutoGeneratedParameterChar + parameter.Name, DapperQueryBuilderOptions.AutoGeneratedParameterChar + newParameterName); //TODO: Split Parameter.Name into Name and ObjectName?
            }
