...
namespace DapperQueryBuilder
{
    ...
    public class ParameterInfos : Dictionary<string, ParameterInfo>, SqlMapper.IDynamicParameters, SqlMapper.IParameterCallbacks
    {
        ...
        public string Add(object value, DbType? dbType = null, ParameterDirection? direction = null)
        {
            ...
            string newParameterName = DapperQueryBuilderOptions.AutoGeneratedParameterName + (isEnumerable ? DapperQueryBuilderOptions.ParameterArrayNameSuffix : "") + Values.Count;
        ...
        public string MergeParameter(ParameterInfo parameter)
        {
            ...
            string newParameterName = DapperQueryBuilderOptions.AutoGeneratedParameterName + (isEnumerable ? DapperQueryBuilderOptions.ParameterArrayNameSuffix : "") + ParameterNames.Count;
