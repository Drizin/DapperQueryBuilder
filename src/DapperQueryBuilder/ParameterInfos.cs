...
namespace DapperQueryBuilder
{
    ...
    /// </summary>
    public class ParameterInfos : SqlMapper.IDynamicParameters, SqlMapper.IParameterCallbacks
    {
        #region members
        private DynamicParameters _dapperParameters = null;
        private readonly Dictionary<string, ParameterInfo> _parameterDic = new Dictionary<string, ParameterInfo>(StringComparer.OrdinalIgnoreCase);
        #endregion
        ...
        public virtual DynamicParameters DapperParameters
        {
            get
            {
                if (_dapperParameters == null)
                {
                    ...
                    foreach (var parameter in _parameterDic.Values)
                    {
        ...
        #region LINQ
        /// <summary>
        /// Determines if ParameterInfos contains any parameters.
        /// </summary>
        /// <returns></returns>
        public bool Any()
        {
            return _parameterDic.Any();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public int Count => _parameterDic.Count;


        /// <summary>
        /// All parameters
        /// </summary>
        public ICollection<ParameterInfo> Values => _parameterDic.Values.Count == 0 ? null : _parameterDic.Values;
        ...
        {
            _parameterDic[parameter.Name] = parameter;
        }
        ...
        public string Add(object value, DbType? dbType = null, ParameterDirection? direction = null)
        {
            ...
            string newParameterName = DapperQueryBuilderOptions.AutoGeneratedParameterName + (isEnumerable ? "array" : "") + _parameterDic.Count;
            if (DapperQueryBuilderOptions.ReuseIdenticalParameters)
            {
                var existingParam =
                    _parameterDic.Values.FirstOrDefault(p =>
                        p.DbType == dbType
        ...
        /// Get parameter value
        /// </summary>
        public T Get<T>(string key) => (T)((ParameterInfo)this[key]).Value;

        /// <summary>
        /// Parameter Names
        /// </summary>
        public HashSet<string> ParameterNames => new HashSet<string>(_parameterDic.Keys);

        /// <summary>
        /// Get ParameterInfo by name
        /// </summary>
        /// <param name="name"></param>
        /// <returns></returns>
        public ParameterInfo this[string name] => _parameterDic[name];
        ...
        void SqlMapper.IParameterCallbacks.OnCompleted()
        {
            ...
            foreach (var oparm in _parameterDic.Values.Where(p => p.ParameterDirection != ParameterDirection.Input))
            {
