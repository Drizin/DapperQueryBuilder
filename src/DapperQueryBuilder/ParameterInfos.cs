        ...
        public string Add(object value, DbType? dbType = null, ParameterDirection? direction = null)
        {
            if (DapperQueryBuilderOptions.ReuseIdenticalParameters)
            {
                ...
                if (existingParam != null)
                    return DapperQueryBuilderOptions.AutoGeneratedParameterPrefix + existingParam.Name.Substring(DapperQueryBuilderOptions.AutoGeneratedParameterObjectPrefix.Length);
            }

            var parmCount = Values.Count;
            var parmName = DapperQueryBuilderOptions.AutoGeneratedParameterPrefix + parmCount.ToString();
            var parmObjectName = DapperQueryBuilderOptions.AutoGeneratedParameterObjectPrefix + parmCount.ToString();
